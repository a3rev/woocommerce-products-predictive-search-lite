...
<?php
/*-----------------------------------------------------------------------------------
WC Predictive Search Global Settings Tab
...
class WC_Predictive_Search_Global_Settings_Tab extends WC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_predictive_search_global_settings_tab_manager',
		);
...
$wc_predictive_search_global_settings_tab = new WC_Predictive_Search_Global_Settings_Tab();
