...
* Tweak - Update meta box for compatibility with WordPress 7.0 Block Editor
...
= 4.4.0 =
This feature adds support for Grid View of Product, SKU, Product Categories & Product Tags results on All Results Page. Settings are on the All Results Pages tab - it is ON by default and can be turned OFF from there if desired.
...
= 4.0.2 =
Maintenance Update. 1 underscore template bug fix and full compatibility with WooCommerce 3.0.3 and WordPress 4.7.3

= 4.0.1 =
Maintenance Update. 2 bug fixes from yesterday's major version 4.0.0 release

= 4.0.0 =
Feature Upgrade. Introducing Predictive Search Split Search. Faster and smarter search plus full compatibility with new WooCommerce V3.0 + with backward compatibility to WC v 2.6.0

= 3.7.0 =
Feature Upgrade. IMPORTANT Clear site cache after upgrading! 3 new features, 9 code changes. Full compatibility with WooCommerce v 2.6.14 and WordPress v 4.7.2

= 3.6.6 =
Maintenance Update. 1 bug fix plus full compatibility with WordPress version 4.7.0 RC1

= 3.6.5 =
Maintenance Update. 1 Bug fix for when product Image url is empty and 1 code tweak for full compatibility with WooCommerce 2.6.8

= 3.6.4 =
Maintenance Update. 9 major code tweaks , 2 minor menu tweaks and 1 bug fix

= 3.6.3 =
Maintenance Upgrade. Quick patch for bug in release 3.6.2 that cause home page not to load

= 3.6.2 =
Major Maintenance Update. Complete rebuild of the Search Engine database sync function and admin interface

= 3.6.1 =
Maintenance Update. 1 Bug Fix plus 1 Tweak to update text domain for translations and full compatibility with WordPress version 4.6.1

= 3.6.0 =
Feature Upgrade. 2 new features including new BROAD search mode option - needs to be activated from the Settings menu. IMPORTANT! Turn ON No-Cache to see new search mode. Plus 7 Tweaks and 1 small bug fix

= 3.5.1 =
Maintenance Update. 2 Tweaks to make the Search Box Results dropdown container the full width of the search box when Full width option is selected.

= 3.5.0 =
Major Feature Upgrade. 6 new features (see changelog) plus full compatibility with WordPress 4.6.0 and WooCommerce 2.6.4. Please upgrade as we have more features coming that require this upgrade first

= 3.4.1 =
Maintenance Update. 1 Bug fix for sites that choose to deactivate Ajax add to cart buttons on archive pages

= 3.4.0 =
Feature Upgrade. Full upgrade to a3 Plugin mobile first framework. All new admin panel UI with open and closing setting boxes. Full compatibility with WooCommerce 2.6.2 and WordPress 4.5.3

= 3.3.3 =
Maintenance Update. Update now for full compatibility with WooCommerce version 2.6.1

= 3.3.2 =
Maintenance update. 1 tweak and 1 bug fix for full compatibility with WooCommerce 2.5.5 and WordPress 4.5.2

= 3.3.1 =
Maintenance Update. 2 Tweaks for full compatibility with upcoming Major WordPress Version 4.5

= 3.3.0 =
Feature Upgrade. 2 new features with 3 tweaks and 1 bug fix for full compatibility with WPML v3.3.6

= 3.2.0 =
Feature Upgrade. IMPORTANT! Clear site cache, browser cache, CDNs after this upgrade -3 new features (see change log) plus 7 code tweaks and 1 bug fix for full compatibility with WooCommerce 2.5.2 and WordPress 4.4.2

= 3.1.0 =
Feature Upgrade with 3 new features and a code tweak for full compatibility with WooCommerce 2.5.1 and WordPress 4.4.1

= 3.0.3 =
Maintenance Update. 4 code tweaks and 3 bug fixes for full compatibility with WordPress 4.4 and WooCommerce 2.4.12

= 3.0.2 =
Maintenance Update. 6 code tweaks and 2 bug fixes for full compatibility with WordPress v4.3.1, WooCommerce v2.4.8 and WPML v3.2.7

= 3.0.1 =
Major Maintenance Upgrade. 8 Code Tweaks plus for full compatibility with WordPress v 4.3.0 and WooCommerce v 2.4.4
...
= 2.2.0 =
Upgrade you plugin now to the a3rev plugin framework with app style admin interface.
