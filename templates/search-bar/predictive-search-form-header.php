...
<div class="wc_ps_bar <?php echo ( 'yes' == $ps_args['search_icon_mobile'] ? 'search_icon_only' : '' ); ?>">
	...
	<div class="wc_ps_mobile_icon header_temp" data-ps-id="<?php echo $ps_id; ?>" aria-label="<?php _e( 'Open Search', 'woocommerce-predictive-search' ); ?>">
	...
	<div class="wc_ps_container wc_ps_header_container <?php echo is_rtl() ? 'rtl' : ''; ?>" id="wc_ps_container_<?php echo $ps_id; ?>">
		<form
			class="wc_ps_form"
