...
<div class="wc_ps_bar <?php echo ( 'yes' == $ps_args['search_icon_mobile'] ? 'search_icon_only' : '' ); ?>">
	...
	<div class="wc_ps_mobile_icon sidebar_temp" data-ps-id="<?php echo esc_attr( $ps_id ); ?>" aria-label="<?php esc_attr_e( 'Open Search', 'woocommerce-predictive-search' ); ?>">
	...
	<div class="wc_ps_container wc_ps_sidebar_container <?php echo is_rtl() ? 'rtl' : ''; ?>" id="wc_ps_container_<?php echo esc_attr( $ps_id ); ?>">
		<form
			class="wc_ps_form"
			id="wc_ps_form_<?php echo esc_attr( $ps_id ); ?>"
			autocomplete="off"
			action="<?php echo esc_url( $search_results_page ); ?>"
			method="get"

			data-ps-id="<?php echo esc_attr( $ps_id ); ?>"
			data-ps-cat_align="<?php echo esc_attr( $ps_args['cat_align'] ); ?>"
			data-ps-cat_max_wide="<?php echo esc_attr( $ps_args['cat_max_wide'] ); ?>"
			data-ps-popup_wide="<?php echo esc_attr( $ps_args['popup_wide'] ); ?>"
		...
		>
			...
			<div class="wc_ps_nav_right">
				<div class="wc_ps_nav_submit">
					...
					<input data-ps-id="<?php echo esc_attr( $ps_id ); ?>" class="wc_ps_nav_submit_bt" type="button" value="<?php esc_attr_e( 'Go', 'woocommerce-predictive-search' ); ?>">
				</div>
			</div>

			<div class="wc_ps_nav_fill">
				<div class="wc_ps_nav_field">
					<input type="text" name="rs" class="wc_ps_search_keyword" id="wc_ps_search_keyword_<?php echo esc_attr( $ps_id ); ?>"
						aria-label="<?php esc_attr_e( 'Keyword Search', 'woocommerce-predictive-search' ); ?>"
						...
						data-ps-show_price="<?php echo esc_attr( $ps_args['show_price'] ); ?>"
						data-ps-show_addtocart="<?php echo esc_attr( $ps_args['show_addtocart'] ); ?>"
						data-ps-show_in_cat="<?php echo esc_attr( $ps_args['show_in_cat'] ); ?>"
					/>
					<svg aria-hidden="true" viewBox="0 0 512 512" class="wc_ps_searching_icon" style="display: none;" aria-label="<?php esc_attr_e( 'Searching', 'woocommerce-predictive-search' ); ?>">
