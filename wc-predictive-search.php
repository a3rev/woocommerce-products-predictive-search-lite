...
if ( version_compare( PHP_VERSION, '5.6.0', '>=' ) ) {
	 ...
	 */
	$GLOBALS[WOOPS_PREFIX.'admin_interface'] = new FrameWork\Admin_Interface();

	global $wc_admin_predictive_search_page;
	$wc_admin_predictive_search_page = new FrameWork\Pages\Predictive_Search();

	$GLOBALS[WOOPS_PREFIX.'admin_init'] = new FrameWork\Admin_Init();

	$GLOBALS[WOOPS_PREFIX.'less'] = new FrameWork\Less_Sass();
